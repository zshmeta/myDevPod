...
class Html
{
	...
	public function getHead($font_awesome = false)
	{
		...
		$html = <<<HTML
			...
			<!-- Meta -->
			<meta name="description" content="Devpod - LAMP/LEMP Stacks.">
			<meta name="author" content="zshmeta">
devilbox
			<!-- Favicons -->
			<link rel="apple-touch-icon" sizes="57x57" href="/assets/favicon/zshico128x128.ico">
			<link rel="apple-touch-icon" sizes="60x60" href="/assets/favicon/zshico128x128.ico">
			<link rel="apple-touch-icon" sizes="72x72" href="/assets/favicon/zshico128x128.ico">
			<link rel="apple-touch-icon" sizes="76x76" href="/assets/favicon/zshico128x128.ico">
			<link rel="apple-touch-icon" sizes="114x114" href="/assets/favicon/zshico128x128.ico">
			<link rel="apple-touch-icon" sizes="120x120" href="/assets/favicon/zshico128x128.ico">
			<link rel="apple-touch-icon" sizes="144x144" href="/assets/favicon/zshico128x128.ico">
			<link rel="apple-touch-icon" sizes="152x152" href="/assets/favicon/zshico128x128.ico">
			<link rel="apple-touch-icon" sizes="180x180" href="/assets/favicon/zshico128x128.ico">
			<link rel="icon" type="image/png" sizes="192x192"  href="/assets/favicon/zshico128x128.ico">
			<link rel="icon" type="image/png" sizes="32x32" href="/assets/favicon/zshico128x128.ico">
			<link rel="icon" type="image/png" sizes="96x96" href="/assets/favicon/zshico128x128.ico">
			<link rel="icon" type="image/png" sizes="16x16" href="/assets/favicon/zshico128x128.ico">
			<link rel="manifest" href="/manifest.json">
			<meta name="msapplication-TileColor" content="#ffffff">
			<meta name="msapplication-TileImage" content="/assets/favicon/zshico64x64.png">
		...
		$html = <<<HTML
			<nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse">
				...
				<a class="navbar-brand" href="/index.php">
					<img src="/assets/img/logo.png" width="30" height="30" class="d-inline-block align-top" alt="">devpod
				</a>
			...
			<nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse footer">
				<div class="container justify-content-end">
					<ul class="nav navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" target="_blank" href="https://github.com/zshmeta/myDevPod"><code>Github</code></a></li>
